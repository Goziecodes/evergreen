  ...
  return (
    <>
      ...
      <div className=" flex flex-col justify-center mb-2">
        ...
        <a
          // type="button"
          href={`https://api.whatsapp.com/send?phone=2348063426769&text=I%20am%20interested%20in%20this%20${product.name}%20https://www.evergtech.com/product/${product.slug.current}`}
